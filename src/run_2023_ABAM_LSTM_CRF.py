...
from models import TokenBERT_abam_LSTM_CRF_bert
...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default='../models_final_abam_lstm/',
...
#词性
    ...
    if args.train:
        ...
        # Model
        model = TokenBERT_abam_LSTM_CRF_bert(
