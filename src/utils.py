...
class InputFeatures(object):
    ...
    def __init__(self, input_ids, attention_mask, token_type_ids, AM_label_ids, AS_label_ids, sentence_hash):
        self.input_ids = input_ids
        self.attention_mask = attention_mask
        self.token_type_ids = token_type_ids
        self.AM_label_ids = AM_label_ids
        self.AS_label_ids = AS_label_ids
        self.sentence_hash = sentence_hash

class InputFeatures_QA(object):
    '''
        A single set of features of data.
    '''

    def __init__(self, pro_input_ids, pro_attention_mask, pro_token_type_ids, con_input_ids, con_attention_mask, con_token_type_ids, pro_label_ids, con_label_ids, pieces2word, AM_label_ids, AS_label_ids, sentence_hash):
        self.pro_input_ids = pro_input_ids
        self.pro_attention_mask = pro_attention_mask
        self.pro_token_type_ids = pro_token_type_ids
        self.con_input_ids = con_input_ids
        self.con_attention_mask = con_attention_mask
        self.con_token_type_ids = con_token_type_ids
...
class InputFeatures_QA2(object):
    '''
        A single set of features of data.
    '''

    def __init__(self, pro_input_ids, pro_attention_mask, pro_token_type_ids, con_input_ids, con_attention_mask, con_token_type_ids, pro_label_ids, no_input_ids, no_attention_mask, no_token_type_ids, con_label_ids, sent_length, pieces2word, label_mask, AM_label_ids, AS_label_ids, sentence_hash):
        self.pro_input_ids = pro_input_ids
        self.pro_attention_mask = pro_attention_mask
        self.pro_token_type_ids = pro_token_type_ids
        self.con_input_ids = con_input_ids
        ...
        self.pro_label_ids = pro_label_ids
        self.con_label_ids = con_label_ids
        self.no_input_ids = no_input_ids
        self.no_attention_mask = no_attention_mask
...
class InputFeatures_char_word_pos(object):
    '''
        A single set of features of data.
    '''

    def __init__(self, input_ids, attention_mask, token_type_ids, word_length, char_ids, char_len, pos_ids, pieces2word, graph, label_mask, AM_label_ids, AS_label_ids, sentence_hash):
        self.input_ids = input_ids
        self.attention_mask = attention_mask
        self.token_type_ids = token_type_ids
...
class InputFeatures_char_word_pos2(object):
    '''
        A single set of features of data.
    '''

    def __init__(self, input_ids, attention_mask, token_type_ids, word_length, char_ids, char_len, pos_ids, pieces2word, graph, label_mask, as_mask, am_mask, AM_label_ids, AS_label_ids, topic, token_spacy_ids, sentence_hash):
        self.input_ids = input_ids
        self.attention_mask = attention_mask
        self.token_type_ids = token_type_ids
        self.word_length = word_length
        ...
        self.AS_label_ids = AS_label_ids
        self.topic = topic
        self.token_spacy_ids = token_spacy_ids
        self.sentence_hash = sentence_hash

class InputFeatures_head_tail(object):
    '''
        A single set of features of data.
    '''

    def __init__(self, input_ids, attention_mask, token_type_ids, word_length, char_ids, char_len, pos_ids, pieces2word, graph, label_mask, head_label, tail_label, as_mask, am_mask, AM_label_ids, AS_label_ids, sentence_hash):
        self.input_ids = input_ids
        self.attention_mask = attention_mask
        self.token_type_ids = token_type_ids
        self.word_length = word_length
...
class InputFeatures_AURC(object):
    '''
        A single set of features of data.
    '''

    def __init__(self, input_ids, attention_mask, token_type_ids, word_length, pieces2word, graph, label_mask, head_label, tail_label, am_mask, AM_label_ids):
        self.input_ids = input_ids
        self.attention_mask = attention_mask
        self.token_type_ids = token_type_ids
        self.word_length = word_length
...
class InputFeatures_pre(object):
    '''
        A single set of features of data.
    '''
...
def get_data_with_labels2(all_input_tokens, all_y_true, all_y_pred):
    count_s = 0
    DATA = dict()
    for count_t, (tokens, y_true, y_pred)  in enumerate(zip(all_input_tokens, all_y_true, all_y_pred)):
        seq_len = len(tokens)
