...
def main():
    ...
    parser.add_argument('--train_batch_size', type=int, default=24, help='Your train set batch size.')
    parser.add_argument('--eval_batch_size', type=int, default=24, help='Your evaluation set batch size.')
    parser.add_argument('--test_batch_size', type=int, default=24, help='Your test set batch size.')
    ...
    parser.add_argument('--output_dir', type=str, default='../models_final1122_bs24/',
