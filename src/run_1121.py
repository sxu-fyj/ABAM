...
#span2term部分，使用span来抽象到句子部分。还是在句子表示上做序列标注
import os
...
from models import TokenBERT_1121
...
def main():
    ...
    parser.add_argument('--eval_batch_size', type=int, default=64, help='Your evaluation set batch size.')
    parser.add_argument('--test_batch_size', type=int, default=64, help='Your test set batch size.')
    ...
    parser.add_argument('--output_dir', type=str, default='../models_final1121/',
