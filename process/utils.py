...
def get_data_with_labels(all_input_tokens, all_y_true, all_y_pred, stances, isarguments):
    count_s = 0
    DATA = dict()
    for count_t, (tokens, y_true, y_pred, stance, isargument) in enumerate(
            zip(all_input_tokens, all_y_true, all_y_pred, stances, isarguments)):
        ...
        DATA[count_t]['stance'] = stance
        DATA[count_t]['isargument'] = isargument
