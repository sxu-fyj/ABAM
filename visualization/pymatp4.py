...
for i, j in iters:
    if i != 3:
        ...
        color = 'Black'
    if (i == j):
        ax1.text(j, i, format(confusion_matrix[i, j]), va='center', ha='center', fontsize=9, color = color,
                 weight=5)  # 显示对应的数字
        #ax1.text(j, i + 0.12, pshow[i, j], va='center', ha='center', fontsize=9, color = color,)
    else:
        ax1.text(j, i, format(confusion_matrix[i, j]), va='center', ha='center', fontsize=9)  # 显示对应的数字
        #ax1.text(j, i + 0.12, pshow[i, j], va='center', ha='center', fontsize=9)
...
for i, j in iters:
    if i != 3:
        ...
        color = 'Black'
    if (i == j):
        ax2.text(j, i, format(confusion_matrix[i, j]), va='center', ha='center', fontsize=9, color = color,
                 weight=5)  # 显示对应的数字
        # ax2.text(j, i + 0.12, pshow[i, j], va='center', ha='center', fontsize=9, color = color,)
    else:
        ax2.text(j, i, format(confusion_matrix[i, j]), va='center', ha='center', fontsize=9)  # 显示对应的数字
...
for i, j in iters:
    if i != 3:
        ...
        color = 'Black'
    if (i == j):
        ax3.text(j, i, format(confusion_matrix[i, j]), va='center', ha='center', fontsize=9, color = color,
                 weight=5)  # 显示对应的数字
        # ax3.text(j, i + 0.12, pshow[i, j], va='center', ha='center', fontsize=9, color = color,)
    else:
        ax3.text(j, i, format(confusion_matrix[i, j]), va='center', ha='center', fontsize=9)  # 显示对应的数字
...
for i, j in iters:
    if i != 3:
        ...
        color = 'Black'
    if (i == j):
        ax4.text(j, i, format(confusion_matrix[i, j]), va='center', ha='center', fontsize=9, color = color,
                 weight=5)  # 显示对应的数字
        # ax4.text(j, i + 0.12, pshow[i, j], va='center', ha='center', fontsize=9, color = color,)
    else:
        ax4.text(j, i, format(confusion_matrix[i, j]), va='center', ha='center', fontsize=9)  # 显示对应的数字
...
for i, j in iters:
    if i != 3:
        ...
        color = 'Black'
    if (i == j):
        ax5.text(j, i, format(confusion_matrix[i, j]), va='center', ha='center', fontsize=9, color = color,
                 weight=5)  # 显示对应的数字
    else:
        ax5.text(j, i, format(confusion_matrix[i, j]), va='center', ha='center', fontsize=9)  # 显示对应的数字
